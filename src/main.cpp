...
std::string read_file_into_string(const fs::path &filename)
{
  ...
  if (ifs.fail())
    throw std::runtime_error("Error reading '"s + filename.string() + "'");
...
int main(int argc, const char **argv)
{
  ...
  try {
    ...
    desc.add_options()("help,h", "print usage message")(
        "verbose,v", "be verbose")("eval,e", po::value<string>(), "string")(
        "ast,p", "print AST to stdout")("lex,l", "Perform lexing only");
