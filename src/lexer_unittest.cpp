...
// template <typename... Args>
// Lexer make_lexer(Args&&... args)
// {
//   return Lexer(std::initializer_list<Token>{std::forward<Args>(args)...});
// }

// TEST_CASE("Punctuators")
// {

//   auto expected = make_lexer(
//       "!", "!=", "!==", "%", "%=", "&", "&&", "&=", "(", ")", "*", "*=", "+",
//       "++", "+=", ",", "-", "--", "-=", ".", ":", ";", "<", "<<",
//       "<<=", "<=", "=", "==", "===", ">", ">=", ">>", ">>=", ">>>", ">>>=",
//       "?",
...
// // {
// //   auto expected = Lexer(make_tokens("var", "x", "=", 1.0));
